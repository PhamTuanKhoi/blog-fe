function Home() {
   return (
      <div className="container">
         <div className="post-title">Post tiitle 1</div>
         <div className="title-content">
            <div className="internation">
               <div className="inter-name">Namw ho</div>
               <div className="inter-date">22/02/2000</div>
            </div>
            <div className="tag">
               <div>tag</div>
            </div>
         </div>
         <div className="content-main">anh yeu em vl</div>
         <div className="number-cmt">5 replies</div>
         <hr />
         <div className="title-content">
            <div className="logo">
               <img
            ...
            <div className="cmt">
               <div className="title-content">
                  <div className="name-cmt">name</div>
                  <div>time</div>
               </div>
               <div className="main-cmt">anh deoy</div>
            </div>
         </div>
      </div>
   );
